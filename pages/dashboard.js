        ...
        >       
            ...
            >
                ...
                <Flex justifyContent="space-between" mt={8}>
                    <Flex align="flex-end">
                        <Heading as="h2" size="lg" letterSpacing="tight">Transaction</Heading>
                                    ...
                                    <Td>
                                        <Flex align="center">
                                            ...
                                            <Flex flexDir="column">
                                                ...
                                                <Text fontSize="sm" color="gray">July 1, 2021 at 3:00pm</Text>
                                            </Flex>
                                        </Flex>
                                    </Td>
                                    <Td>Macbook air </Td>
                                    <Td isNumeric>+$10</Td>
                                    <Td isNumeric><Text fontWeight="bold" display="inline-table">-$999</Text>.00</Td>
                                </Tr>
                                <Tr>
                                    <Td>
                                        <Flex align="center">
            ...
            >
                ...
                <Heading letterSpacing="tight">Credit Cards</Heading>
                {value == 1 &&
                    <Box
                        borderRadius="25px"
                        mt={4}
                        w="100%"
                        h="200px"
                        bgGradient="linear(to-t, #f69d3c, #3f87a6)"
                    >
                ...
                <Flex flexDir="column" my={4}>
                    <Flex justifyContent="space-between" mb={2}>
                        <Text>Balance</Text>
                        <Text fontWeight="bold">$150.12</Text>
                    </Flex>
                    <Flex justifyContent="space-between" mb={2}>
                        <Text>Credit Limit</Text>
                        <Text fontWeight="bold">$50.12</Text>
                    </Flex>
                </Flex>
                ...
                <Flex>
                    <AvatarGroup size="md" max={3}>
                        ...
                        <Avatar src="avatar-6.jpg" />
                    </AvatarGroup>
                    <Avatar icon={<FiPlus />} color="#fff" ml={2} bgColor="green.100" />
                </Flex>
